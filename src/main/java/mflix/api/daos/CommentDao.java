...
public class CommentDao extends AbstractMFlixDao {
    ...
    public Comment addComment(Comment comment) {
        ...
        try {
            ...
            log.error("An error occurred while trying to insert a comment");
            return null;
        }
        return comment;
    }
    ...
    public boolean updateComment(String commentId, String text, String email) {
        ...
        try {
            ur = commentCollection.updateOne(
                    and(eq("_id", new ObjectId(commentId)), eq("email", email)), combine(set("text", text), set("date", new Date()))
            );
        } catch (MongoException e) {
            log.error("An error occurred while trying to update a comment");
            return false;
        }
    ...
    public boolean deleteComment(String commentId, String email) {
        ...
        try {
            ...
            log.error("An error occurred while trying to delete a comment");
            return false;
        }
