...
public class UserDao extends AbstractMFlixDao {
    ...
    public boolean addUser(User user) {
        ...
        try {
            ...
            log.error("An error occurred while trying to insert a user");
    ...
    public boolean createUserSession(String userId, String jwt) {
        ...
        try{
            ...
            log.error("An error occurred while trying to insert/update a session");
            return  false;
        }
        return true;
    ...
    public boolean deleteUser(String email) {
        ...
        try {
            ...
            log.error("An error occurred while trying to delete a user");
            return false;
        }
        return true;
    }
    ...
    public boolean updateUserPreferences(String email, Map<String, ?> userPreferences) {
        ...
        try {
            usersCollection.updateOne(eq("email", email), set("preferences", Optional.ofNullable(userPreferences).orElseThrow(() -> new IncorrectDaoOperation("user preference cannot be null"))));
        } catch (MongoException e) {
